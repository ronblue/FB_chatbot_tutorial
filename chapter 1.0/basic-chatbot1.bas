...
DIM AS STRING keywords1(0 TO 3) => {"bad", "awful", "average", "don't know"}

DIM AS STRING replies1(0 TO 3) => {"i'm sorry to hear that... hope your day will get better", _
...
DIM AS STRING keywords2(0 TO 3) => {"good", "wonderful", "excellent", "best day ever"}

DIM AS STRING replies2(0 TO 3) => {"i'm so happy for you!", "that's great! can you tell me about your day?", _
                                   "what did you do today?", "please tell me more :)"}

DIM AS STRING nokeyfound(0 TO 3) => {"i see go on", "that is interesting", "how does that make you feel?", _
                                     "i understand"}
